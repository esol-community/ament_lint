...
if(_source_files)
  ...
  if(DEFINED ament_cmake_haros_ADDITIONAL_INCLUDE_DIRS)
    list(APPEND _all_include_dirs ${ament_cmake_haros_ADDITIONAL_INCLUDE_DIRS})
  endif()
  ...
  if(NOT CMAKE_VERSION VERSION_LESS "3.7.0")
    ...
    foreach(_target ${_build_targets})
      ...
      #     2. HAROS will not check for errors in external packages
  ...
  message(STATUS "Configured haros include dirs: ${_all_include_dirs}")
  ament_haros(INCLUDE_DIRS ${_all_include_dirs})
endif()
