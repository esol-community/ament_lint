...
Performs a static code analysis of C / C++ source files using `HAROS
...
The command line tool is provided by the package `ament_haros
...
.. code:: xml
    ...
    <test_depend>ament_cmake_haros</test_depend>
